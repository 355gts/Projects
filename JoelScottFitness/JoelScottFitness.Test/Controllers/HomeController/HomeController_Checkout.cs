...
//            BasketItemViewModel basketItem1;
//            BasketItemViewModel basketItem2;
//            IDictionary<long, BasketItemViewModel> basketItems;
...
//                basketItem1 = new BasketItemViewModel() { PlanId = planId1, Price = planPrice1 };
//                basketItem2 = new BasketItemViewModel() { PlanId = planId2, Price = planPrice2 };
//                basketItems = new Dictionary<long, BasketItemViewModel>()
//                {
//                    { basketItem1.Id, basketItem1 },
//                    { basketItem2.Id, basketItem2 },
//            };
...
//                Assert.IsNotNull(confirmPurchaseViewModelCallback);
//                Assert.AreEqual(2, confirmPurchaseViewModelCallback.Basket.Items.Count());
//                Assert.AreEqual(planPrice1 - (planPrice1 / 100 * discountPercentage), confirmPurchaseViewModelCallback.Basket.Items.First(b => b.Value.Id == planId1).Value.Price);
//                Assert.AreEqual(planPrice2 - (planPrice2 / 100 * discountPercentage), confirmPurchaseViewModelCallback.Basket.Items.First(b => b.Value.Id == planId2).Value.Price);
//                Assert.AreEqual(paymentId, confirmPurchaseViewModelCallback.PayPalReference);
//                Assert.AreEqual(transationId, confirmPurchaseViewModelCallback.TransactionId);
