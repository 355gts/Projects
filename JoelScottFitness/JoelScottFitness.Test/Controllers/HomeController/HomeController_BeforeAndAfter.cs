...
//            [TestMethod]
//            public void BeforeAndAfter_ModelStateInvalid_ReturnsViewResult()
//            {
//                // setup
//                beforeFileMock.Setup(f => f.ContentLength).Returns(0);
//                afterFileMock.Setup(f => f.FileName).Returns(string.Empty);
//                beforeAndAfterViewModel.Comment = string.Empty;

//                // test
//                var result = controller.BeforeAndAfter(beforeAndAfterViewModel).Result as ViewResult;
...
//                Assert.AreEqual(3, controller.ModelState.Values.First().Errors.Count());

//                var modelErrors = controller.ModelState.Values.First().Errors.Select(e => e.ErrorMessage).ToList();
//                Assert.AreEqual(1, modelErrors.Count(e => e == string.Format(Settings.Default.ImageUploadErrorMessage, "After Image")));
//                Assert.AreEqual(1, modelErrors.Count(e => e == string.Format(Settings.Default.ImageUploadErrorMessage, "Before Image")));
//                Assert.AreEqual(1, modelErrors.Count(e => e == Settings.Default.MissingCommentErrorMessage));
//            }

//            [TestMethod]
//            public void BeforeAndAfter_UploadBeforeFileFails_ReturnsRedirectToRouteResult()
//            {
//                // setup
//                fileHelperMock.SetupSequence(f => f.UploadFile(It.IsAny<HttpPostedFileBase>(), It.IsAny<string>(), It.IsAny<string>()))
...
//                // test
//                var result = controller.BeforeAndAfter(beforeAndAfterViewModel).Result as RedirectToRouteResult;
...
//                Assert.AreEqual(string.Format(Settings.Default.FailedToUploadHallOfFameImagesErrorMessage, purchasedItemId), result.RouteValues["errorMessage"]);
//            }

//            [TestMethod]
//            public void BeforeAndAfter_UploadAfterFileFails_ReturnsRedirectToRouteResult()
//            {
//                // setup
//                fileHelperMock.SetupSequence(f => f.UploadFile(It.IsAny<HttpPostedFileBase>(), It.IsAny<string>(), It.IsAny<string>()))
...
//            [TestMethod]
//            public void BeforeAndAfter_UploadHallOfFameAsyncFails_ReturnsRedirectToRouteResult()
//            {
//                // setup
//                jsfServiceMock.Setup(s => s.UploadHallOfFameAsync(It.IsAny<long>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
//                              .ReturnsAsync(false);
...
//                Assert.AreEqual("Error", result.RouteValues["action"]);
//                Assert.AreEqual("Home", result.RouteValues["controller"]);
//                Assert.AreEqual(string.Format(Settings.Default.FailedToUploadHallOfFameErrorMessage, purchasedItemId), result.RouteValues["errorMessage"]);
//            }

//            [TestMethod]
//            public void BeforeAndAfter_FormatsFileNames_ReturnsRedirectToRouteResult()
//            {
//                // setup
...
//                Assert.IsNotNull(result);
//                Assert.AreEqual("MyPlans", result.RouteValues["action"]);
//                Assert.AreEqual("Home", result.RouteValues["controller"]);
...
//            [TestMethod]
//            public void BeforeAndAfter_Success_ReturnsRedirectToRouteResult()
//            {
//                // test
//                var result = controller.BeforeAndAfter(beforeAndAfterViewModel).Result as RedirectToRouteResult;
